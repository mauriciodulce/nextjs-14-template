    ...
    data: [
      {
        ...
        content:
          'Learn the basics of Next.js 15 and its powerful features for building modern web apps. This guide covers setup, routing, and data fetching.',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Getting Started with Next.js'),
      ...
      },
      {
        ...
        content:
          'Explore how TypeScript enhances JavaScript development with static typing and better tooling. Learn about interfaces, generics, and more.',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Why TypeScript is a Game Changer'),
      ...
      },
      {
        ...
        content:
          'A step-by-step guide to creating a blog using Prisma and MongoDB for data storage. Covers schema design, queries, and API routes.',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Building a Blog with Prisma and MongoDB'),
      ...
      },
      {
        ...
        content:
          'Discover how React Query makes data fetching and state management easier in React apps. Includes examples and best practices.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('React Query: Simplifying Data Fetching'),
      ...
      },
      {
        ...
        content:
          'Master Tailwind CSS with these advanced tips for creating responsive and beautiful UIs. Learn utility-first CSS techniques.',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Tailwind CSS Tips and Tricks'),
      ...
      },
      {
        ...
        content:
          'Learn how to integrate Clerk for secure and scalable authentication in your Next.js app. Covers setup and user management.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Authentication with Clerk in Next.js'),
      ...
      },
      {
        ...
        content:
          'Techniques to improve the performance of your Next.js applications, including lazy loading and caching strategies.',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Optimizing Next.js Performance'),
      ...
      },
      {
        ...
        content:
          'Best practices for designing schemas and querying data efficiently in MongoDB. Includes indexing and aggregation tips.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
      ...
      },
      {
        ...
        content:
          'How to design and build reusable React components for scalable applications. Covers component composition and props.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Creating Reusable React Components'),
      ...
      },
      {
        ...
        content:
          'Add stunning animations to your web apps with Framer Motion, a powerful animation library for React.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Design',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Introduction to Framer Motion'),
      ...
      },
      {
        ...
        content:
          'A guide to deploying your Next.js application to Vercel with zero configuration. Includes CI/CD setup.',
        coverImage: 'https://images.unsplash.com/photo-1593642532973-d31b97d0eb4c',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Deploying Next.js to Vercel'),
      ...
      },
      {
        ...
        content:
          'Compare different state management solutions like Redux, Zustand, and React Query for React apps.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('State Management in React'),
      ...
      },
      {
        ...
        content:
          'Learn how to create a REST API using Next.js API routes and Prisma for data management.',
        coverImage: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Building a REST API with Next.js'),
      ...
      },
      {
        ...
        content:
          'A comparison of CSS-in-JS libraries and utility-first frameworks like Tailwind CSS for styling.',
        coverImage: 'https://images.unsplash.com/photo-1507238691744-903d9b38b31b',
        category: 'Design',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('CSS-in-JS vs Utility-First CSS'),
      ...
      },
      {
        ...
        content:
          'Best tools and practices for unit and integration testing in Next.js apps, including Jest and Cypress.',
        coverImage: 'https://images.unsplash.com/photo-1593642532973-d31b97d0eb4c',
        category: 'Technology',
        ...
        published: true,
        authorId: user.id,
        slug: generateSlug('Testing Next.js Applications'),
