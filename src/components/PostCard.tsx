  ...
  return (
    ...
    >
      {src ? (
        ...
        <div className="flex h-full w-full items-center justify-center rounded-full bg-gray-200 text-gray-600 text-xs">
      ...
      <Link href={`/posts/${id}`} className="block">
        <div className="relative h-48 overflow-hidden">
          {coverImage ? (
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-violet-500" />
          )}
          {category && (
            <Badge className="absolute top-4 left-4 bg-primary/80 hover:bg-primary text-primary-foreground">
              {category}
            </Badge>
          )}
        </div>
